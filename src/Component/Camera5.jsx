...
Command: npx gltfjsx@6.2.16 ../camera5.gltf -T -i -s --precision 4 
Files: ../camera5.gltf [149.62KB] > C:\Users\xotil\examplethreed\threed\camera5-transformed.glb [195.87KB] (-31%)
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/camera5-transformed.glb')
  return (
    <group {...props} dispose={null}>
      <pointLight intensity={10.9} decay={2} color="#ffeebc" position={[-0.0522, 0.0883, 1.5602]} rotation={[-Math.PI / 2, 0, 0]} />
      <pointLight intensity={20} decay={2} position={[-2.7926, 0.3948, -0.412]} rotation={[-Math.PI / 2, 0, 0]} />
      <pointLight intensity={0} decay={2} position={[-2.6758, 0.4416, 0.9514]} rotation={[-Math.PI / 2, 0, 0]} />
      <pointLight intensity={10} decay={2} position={[0.7178, 0.4416, -0.7183]} rotation={[-Math.PI / 2, 0, 0]} />
      <pointLight intensity={30} decay={2} position={[-2.5024, 1.4108, -0.5715]} rotation={[-Math.PI / 2, 0, 0]} />
      <spotLight intensity={10} decay={2} color="#fffff7" position={[-2.9207, 1.4108, 1.0627]} rotation={[-Math.PI / 2, 0, 0]} />
      <pointLight intensity={10} decay={2} color="#ffecf3" position={[-1.0228, 1.4108, 1.0005]} rotation={[-Math.PI / 2, 0, 0]} />
      <pointLight intensity={10} decay={2} color="#faf3ff" position={[0.445, 1.4108, -0.6201]} rotation={[-Math.PI / 2, 0, 0]} />
      ...
      <PerspectiveCamera makeDefault={true} far={100} near={0.1} fov={107.6187} position={[-3.40219, 0.91692, 0.4566]} rotation={[0,0,0]} scale={0.4072} />
...
useGLTF.preload('/camera5-transformed.glb')
