...
Command: npx gltfjsx@6.2.16 ../camera3.gltf -T -i -s --precision 4 
Files: ../camera3.gltf [149.6KB] > C:\Users\xotil\examplethreed\threed\camera3-transformed.glb [195.84KB] (-31%)
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/camera3-transformed.glb')
  return (
    <group {...props} dispose={null}>
      ...
      <pointLight intensity={30} decay={2} position={[-2.9207, 1.4108, 1.0627]} rotation={[-Math.PI / 2, 0, 0]} />
      ...
      <PerspectiveCamera makeDefault={true} far={100} near={0.1} fov={77.6187} position={[-0.2825, 1.4285, -1.2834]} rotation={[-2.8908, -0.4832, -3.1328]} scale={0.4072} />
...
useGLTF.preload('/camera3-transformed.glb')
